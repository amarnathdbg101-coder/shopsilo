...
export const ProfileScreen = () => {
  ...
  return (
    <AppLayout title="Aapka Profile" subtitle="Account & Dukan Settings">
      ...
      {/* Dukan Details (Spacious & Professional Shop Card) */}
      {shop && (
        <div className="card" style={{ padding: '18px', borderRadius: '16px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', fontSize: '0.84rem', background: 'var(--bg-app)', padding: '12px', borderRadius: '12px', marginBottom: '14px' }}>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '6px' }}>
              <MapPin size={15} color="var(--color-primary)" style={{ flexShrink: 0, marginTop: '2px' }} />
              <div>
                <span style={{ color: 'var(--text-muted)', fontSize: '0.75rem' }}>Pata: </span>
                <span style={{ fontWeight: 600 }}>{[shop.address, shop.city, shop.pincode].filter(Boolean).join(', ') || 'Nahi dala'}</span>
              </div>
            </div>

            <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
              <Clock size={15} color="var(--color-primary)" style={{ flexShrink: 0 }} />
              <div>
                <span style={{ color: 'var(--text-muted)', fontSize: '0.75rem' }}>Timings: </span>
                <span style={{ fontWeight: 600 }}>{shop.opening_time || '09:00'} - {shop.closing_time || '21:00'}</span>
                {shop.weekly_off && <span style={{ color: '#ef4444', fontWeight: 700 }}> (Off: {shop.weekly_off})</span>}
              </div>
            </div>
          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            <button
              ...
              style={{ flex: 1.4, fontWeight: 700, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}
            >
              <Settings size={14} />
            ...
            <a
              ...
              rel="noreferrer"
              className="btn btn-secondary btn-sm"
              style={{ flex: 1, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '5px', fontWeight: 600 }}
            >
