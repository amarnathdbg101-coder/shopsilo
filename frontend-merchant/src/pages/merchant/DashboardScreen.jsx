...
export const DashboardScreen = () => {
  ...
  return (
    <AppLayout>
      ...
      {/* Weekly Discovery & Customer Intent Highlights (From Flutter APK) */}
      <div
        style={{
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '10px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '0.85rem', fontWeight: 800 }}>
            <Sparkles size={16} color="#eab308" /> Customer Discovery This Week
          </div>
          <span style={{ fontSize: '0.72rem', color: '#10b981', fontWeight: 700 }}>Live Insights</span>
        </div>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '8px', textAlign: 'center' }}>
          <div style={{ background: 'var(--bg-app)', padding: '8px 4px', borderRadius: '10px' }}>
            <div style={{ fontSize: '1.05rem', fontWeight: 900, color: 'var(--color-primary)' }}>126</div>
            <div style={{ fontSize: '0.68rem', color: 'var(--text-muted)' }}>Product Views</div>
          </div>
          <div style={{ background: 'var(--bg-app)', padding: '8px 4px', borderRadius: '10px' }}>
            <div style={{ fontSize: '1.05rem', fontWeight: 900, color: '#10b981' }}>42</div>
            <div style={{ fontSize: '0.68rem', color: 'var(--text-muted)' }}>Search Shows</div>
          </div>
          <div style={{ background: 'var(--bg-app)', padding: '8px 4px', borderRadius: '10px' }}>
            <div style={{ fontSize: '1.05rem', fontWeight: 900, color: '#ec4899' }}>28%</div>
            <div style={{ fontSize: '0.68rem', color: 'var(--text-muted)' }}>Visit Intent (GPS)</div>
          </div>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
        ...
        {/* Offers & Promotions (Deals Publisher - From Flutter APK) */}
        <div
          className="card card-clickable"
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontWeight: 700, fontSize: '0.95rem' }}>Offers & Live Promotions</div>
            <div style={{ fontSize: '0.78rem', color: 'var(--text-secondary)' }}>
              Discounts, BOGO aur festival deals publish karein jo customer Deals feed me dikhein
            </div>
          </div>
          <ChevronRight size={18} color="var(--text-muted)" />
        </div>
      ...
      {/* Floating "Ask Pick (Shop Co-Pilot)" Button */}
      <button
